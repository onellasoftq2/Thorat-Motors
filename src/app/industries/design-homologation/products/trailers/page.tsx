...
import { Check, CheckCircle, Search, Truck, Layers, Settings, ShieldCheck, GitBranch } from 'lucide-react';
  ...
  return (
    <div className="bg-background text-foreground overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 md:px-6 lg:px-8">
        ...
        <section className="mt-16 md:mt-24">
            <AnimatedElement className="text-center mb-12">
                <h2 className="text-3xl font-bold font-headline">Trailer Homologation Workflow</h2>
                <div className="mt-3 mb-4 w-20 h-1.5 bg-accent mx-auto"></div>
            </AnimatedElement>
                ...
                <AnimatedElement delay={0.15}>
                    <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                        <Button size="lg" variant="secondary" asChild className="bg-accent text-accent-foreground hover:bg-accent/90">
                            <Link href="/contact">Talk to Our Trailer Compliance Experts</Link>
                        </Button>
                        <Button size="lg" variant="outline" className="border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary">
                             <Link href="/quote?product=Trailer Homologation">Request AIS Review</Link>
                        </Button>
                    </div>
                </AnimatedElement>
            </div>
