...
import { Check, CheckCircle, Search, Truck, Thermometer, Box, Zap, Shield, TestTube, Factory, BrainCircuit } from 'lucide-react';
...
const whyChooseUs = [
    ...
    'Reduced compliance risk for food & pharma logistics.',
    'Faster approvals for complex container integrations.',
    'End-to-end support, from initial design to final certification.',
];
  ...
  return (
    <div className="bg-background text-foreground overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 md:px-6 lg:px-8">
        ...
        <section className="mt-16 md:mt-24">
            <AnimatedElement className="text-center mb-12">
                <h2 className="text-3xl font-bold font-headline">Refer Container Homologation Workflow</h2>
                <div className="mt-3 mb-4 w-20 h-1.5 bg-accent mx-auto"></div>
            </AnimatedElement>
