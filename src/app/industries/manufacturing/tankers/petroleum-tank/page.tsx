...
import { Check, ShieldCheck, Layers, Settings, Workflow, Droplet, Factory, Shield, Flame } from 'lucide-react';
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export default function PetroleumTankPage() {
    ...
    const galleryImages = [
        PlaceHolderImages.find(p => p.id === 'petroleum-tank-gallery-1'),
        PlaceHolderImages.find(p => p.id === 'petroleum-tank-gallery-2'),
        PlaceHolderImages.find(p => p.id === 'petroleum-tank-gallery-3'),
    ];
            ...
            <div className="text-center md:text-left">
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    ...
                    <Button size="lg" variant="outline" asChild>
                        <Link href="/quote?product=petroleum-tank">Enquire Now</Link>
                    </Button>
                </div>
            </div>
            <div>
            ...
            <div className="container mx-auto text-center px-4">
                 ...
                 <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Button size="lg" variant="outline" asChild className="border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary">
                        <Link href="/contact">Talk to Our Engineering & Compliance Team</Link>
                    </Button>
                </div>
            </div>
        </section>
