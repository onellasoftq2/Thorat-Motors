...
export default function GasTankPage() {
    ...
    const galleryImages = [
        PlaceHolderImages.find(p => p.id === 'gas-tank-gallery-1'),
        PlaceHolderImages.find(p => p.id === 'gas-tank-gallery-2'),
        PlaceHolderImages.find(p => p.id === 'gas-tank-gallery-3'),
    ];
            ...
            <div className="text-center md:text-left">
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    ...
                    <Button size="lg" variant="outline" asChild>
                        <Link href="/quote?product=gas-tank">Enquire Now</Link>
                    </Button>
                </div>
            </div>
            <div>
