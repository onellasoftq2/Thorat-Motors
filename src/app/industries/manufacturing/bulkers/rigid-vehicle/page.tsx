...
export default function RigidVehiclePage() {
  const product = products.trailers.find((p) => p.id === 'rigid-vehicle');

  if (!product) {
    return (
        <div className="container mx-auto px-4 py-12 md:py-16 lg:py-24 text-center">
    ...
    <div>
      ...
      <div className="container mx-auto px-4 py-12 md:py-16 lg:py-24 md:px-6 lg:px-8">
        ...
        <div className="mt-16">
          ...
          <div className="mt-6 max-w-4xl mx-auto border rounded-lg overflow-hidden">
            <Table>
              <TableBody>
        ...
        <div className="mt-16 text-center">
            <Button asChild size="lg" className="bg-accent text-accent-foreground hover:bg-accent/90">
                <Link href="/quote?product=rigid-vehicle">Request a Quote for this Product</Link>
            </Button>
        </div>
      </div>
    </div>
