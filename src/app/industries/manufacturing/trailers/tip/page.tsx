...
const configurations = [
    { name: 'Body Capacity', description: 'Range of capacities for different material densities.' },
    { name: 'Tipping Mechanism', description: 'Optimized tipping angles with hydraulic options.' },
    { name: 'Body Construction', description: 'High-tensile steel for handling abrasive materials.' },
    { name: 'Axle & Suspension', description: 'Heavy-duty suspension designed for rough terrain.' },
    { name: 'Custom Builds', description: 'Tailored designs available for specific site challenges.' },
];

const engineeringHighlights = [ "Stable design for safe unloading.", "High-performance hydraulics for speed.", "Reinforced body for abrasive loads.", "Durable fabrication with corrosion resistance." ];

const safetyCompliance = [ "Stability analysis to prevent rollovers.", "Safety valves for controlled operation.", "CMVR and manufacturing standards compliant.", "Integrated braking for full-load performance." ];

const operationalAdvantages = [ 
    { title: "Improved Productivity", description: "Faster unloading cycles improve on-site productivity." },
    { title: "Reduced Labor", description: "Reduces the need for manual labor and extra equipment." },
    { title: "High Reliability", description: "Performs reliably in demanding environments like mines." },
    { title: "Easy Maintenance", description: "Designed for straightforward maintenance to maximize uptime." }
];
...
=======
                    <h1 className="text-3xl font-extrabold tracking-tight font-headline">Tip Trailers</h1>
