...
export default function SkeletalTrailersPage() {
    ...
    const galleryImagesData = [
        PlaceHolderImages.find(img => img.id === 'skeletal-gallery-1'),
        PlaceHolderImages.find(img => img.id === 'skeletal-gallery-2'),
        PlaceHolderImages.find(img => img.id === 'skeletal-gallery-3'),
    ];
