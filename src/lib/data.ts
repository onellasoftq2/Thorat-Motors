    ...
    trailers: [
        {
            ...
            specs: [
                ...
                { name: 'Chassis', value: 'Ladder type construction with cross members. Made with high strength steel. (6mm Flange / 6mm Web / 10mm Flange)' },
                { name: 'Tank Shell', value: '4MM ST 52' },
                { name: 'Tank Dish End', value: '5MM ST 52' },
                { name: 'Certification', value: 'IS 2825 1959 Class-3 & AS 1210 Class 3' },
                { name: 'Discharge', value: 'Rear via Bottom' },
                { name: 'Loading', value: '2 x 450mm diameter hatches' },
                ...
                { name: 'Relief Valve', value: 'Installed in accordance with IS – 2526 Class 3' },
                { name: 'Landing Leg', value: 'Two speed landing leg (HDTPL/YORK)' },
                { name: 'Axles', value: '12T / 14T / 16T (YORK/TATA/FUWA/JOST)' },
                { name: 'King PIN', value: '2” bolted/welded, equivalent to IS: 6763 Part I (YORK/JOST)' },
                { name: 'Suspension', value: 'Heavy Duty Tridem / Tandem / Tandem + Lifting combo axle (YORK/TATA)' },
                { name: 'Brakes', value: 'Twin line air brake system. T 24 brake chamber on all axles. Manually actuated parking brake. (WEBCO)' },
        ...
        },
        {
            ...
            specs: [
                ...
                { name: 'Chassis', value: 'Formed I Beam (10/10/18) ladder type construction, made with high strength steel-BSK46. IS2062 FORMED BEAM 500 SAW welded.' },
                { name: 'Twist Locks', value: '12 nos of twist lock shall be provided to suit 1-40ft, 2–20ft, and 1-20ft container at middle' },
                { name: 'Platform', value: 'Super structure made with ISMC 200 member & heavy duty outer cross member supports. Covered by 4mm MS sheet.' },
                { name: 'Landing Leg', value: 'Two speed landing leg (HDTPL/YORK)' },
                { name: 'Axles', value: '12T / 14T / 16T (YORK/TATA/FUWA/JOST)' },
                { name: 'King Pin', value: '2” bolted/welded, equivalent to IS: 6763 Part I (YORK/JOST)' },
                { name: 'Suspension', value: 'Heavy Duty Tridem / Tandem / Tandem + Lifting combo axle (YORK/TATA)' },
                ...
                { name: 'Electrical', value: '24 V DC electrical system as per CMVR' },
                { name: 'Painting', value: 'Two coats of Epoxy paint shall be provided with Primer' },
                { name_key: 'Other Fitment', value: 'SUPD, RUPD, reflectors on both sides and rear as per CMVR' },
                { name: 'Wheel Rim', value: '10.00 x 20 – 16 PR – 12 Nos. / 7.50 x 20 – 12 Nos.' },
                { name: 'Tyre', value: 'APPOLO / JK TYRE / VIKRANT / MRF / Others' },
        ...
        },
        {
            ...
            specs: [
                ...
                { name: 'Wheel Rim', value: '10.00 x 20 – 16 PR – 12 Nos. / 7.50 x 20 – 12 Nos.' },
                { name: 'Tyre', value: 'APPOLO / JK TYRE / VIKRANT / MRF / Others' },
                { name: 'Application', value: 'Container transportation' },
                { name: 'On Demand Extras', value: 'Trailer ABS/EBS system (Wabco / Haldex / Knorr Bremse), Radial Tyres, Tubeless Tyres & Discs' }
            ],
            features: [
        ...
        },
        {
            ...
            specs: [
                ...
                { name: 'Load Capacity', value: 'Depending on size' },
                { name: 'Chassis', value: 'Formed I Beam (10/10/18) or IS2062 FORMED BEAM 500 SAW welded. Made with high strength steel-BSK46.' },
                { name: 'Platform', value: 'Super structure made with ISMB 250 / ISMC 125 member & heavy duty outer cross member supports. Covered by 4mm MS sheet.' },
                { name: 'Twist Locks', value: '12 nos of twist lock to suit 1-40ft, 2-20ft, and 1-20ft container' },
                { name: 'Landing Leg', value: 'Two speed landing leg (HDTPL/YORK)' },
                { name: 'Axles', value: '12T / 14T / 16T (YORK/TATA/FUWA/JOST)' },
                { name: 'King Pin', value: '2” bolted/welded, equivalent to IS: 6763 Part I (YORK/JOST)' },
                { name: 'Suspension', value: 'Heavy Duty Tridem / Tandem / Tandem + Lifting combo axle (YORK/TATA)' },
                { name: 'Brakes', value: 'Twin line air brake system with T 24 brake chambers and parking brake. (WEBCO)' },
                { name: 'Electrical', value: '24 V DC electrical system as per CMVR' },
                { name: 'Surface Preparation', value: 'Trailer surface shall be Shot blasted and cleaned' },
                { name: 'Painting', value: 'Two coats of Epoxy paint with Primer' },
                { name: 'Other Fitment', value: 'SUPD, RUPD, reflectors on both sides and rear as per CMVR' },
                { name: 'Wheel Rim', value: '10.00 x 20 – 16 PR – 12 Nos. / 7.50 x 20 – 12 Nos.' },
                { name: 'Tyre', value: 'APPOLO / JK TYRE / VIKRANT / MRF / Others' },
                { name: 'Application', value: 'Cement Bags / Loose Material / Marble / Coil / Coal / Clinker / Aggregates / Iron Ore / Salt / Others' },
